...
public class Constants {
	...
	public static final String[] DOCUMENT_PROPERTIES_TO_AVOID = {"iddocument","createTime","documentType", "project"};
	public static final String[] DRAWING_PROPERTIES_TO_AVOID = {"iddrawing","createTime", "project"};
	public static final String[] BILL_PROPERTIES_TO_AVOID = {"idbill","createTime", "project"};
